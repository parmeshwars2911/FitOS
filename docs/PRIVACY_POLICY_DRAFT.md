# FitOS Privacy Policy — 0.1 Beta Draft

**Effective date:** September 9, 2026

> Hosting note: this file is written to match the local-first FitOS 0.1 beta. Before external TestFlight/App Store use, publish this policy at a public HTTPS URL and verify it again against the exact submitted build. If cloud accounts, analytics, subscriptions, or other remote services are enabled later, update this policy before shipping those changes.
...
FitOS may update this Privacy Policy as the product changes. Material changes to data collection or transmission—such as enabling FitOS cloud accounts, remote AI processing, analytics, or other third-party services—should be reflected in an updated policy before those features are released.
...
Before a broad public App Store launch, replace or supplement this developer contact with the production support/privacy contact chosen for FitOS.
